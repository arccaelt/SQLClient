using System;
using static SQLClientWPF.DatabaseVendor;
using SQLClientWPF.db;
using SQLClientWPF.exceptions;
                                    ...
                                    string username=null, string password=null)
        {
            ...
            switch(databaseType)
            {
                case MS_SQL:
                    ...
                    database.supportedKeywords = DatabaseSQLKeywords.MSSQL_KEYWORDS;
                    break;
                case MYSQL:
                    database = createMysqlDatabaseInstace(serverName, username, password);
                    database.supportedKeywords = DatabaseSQLKeywords.MYSQL_KEYWORDS;
                    break;
            }
